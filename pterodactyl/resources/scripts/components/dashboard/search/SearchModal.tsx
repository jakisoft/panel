...
const ServerResult = styled(Link)`
  ${tw`flex items-center bg-elysium-color3 p-4 rounded-2xl no-underline transition-all duration-150`};

  &:hover {
    ${tw`shadow border-l-4 border-cyan-500`};
  }
              ...
              {servers.map((server) => (
                ...
                >
                  ...
                  <div css={tw`flex-none text-right`}>
                    <span
                      css={tw`text-xs py-1 px-2 bg-cyan-800 text-cyan-100 rounded-2xl`}
                    >
                      {server.node}
                    </span>
                  </div>
