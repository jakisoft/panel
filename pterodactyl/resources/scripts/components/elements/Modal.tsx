    ...
    >
      ...
      >
        <ModalContainer alignTop={top}>
          {isDismissable && (
            <div className={"absolute right-0 top-0 m-4 rounded-full"}>
              <Button.Danger
              ...
              >
                <XIcon
                  css={tw`w-5 h-5 group-hover:rotate-90 transition-transform duration-100`}
                />
              </Button.Danger>
            </div>
          )}
          ...
          <div
            css={tw`bg-elysium-color2 p-3 sm:p-4 md:p-6 rounded-2xl shadow-md overflow-y-scroll transition-all duration-150`}
          >
            {children}
          </div>
        </ModalContainer>
