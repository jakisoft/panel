...
<html>
    <head>
        ...
        @php
            $elysiumLogo = optional(\Illuminate\Support\Facades\DB::table('elysium')->first())->logo;
            $adminFavicon = !empty($elysiumLogo) ? $elysiumLogo : '/favicons/favicon.ico';
        @endphp

        <link rel="apple-touch-icon" sizes="180x180" href="{{ $adminFavicon }}">
        <link rel="icon" type="image/png" href="{{ $adminFavicon }}" sizes="32x32">
        <link rel="icon" type="image/png" href="{{ $adminFavicon }}" sizes="16x16">
