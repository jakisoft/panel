                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div style="margin-top: 10px; display: flex; align-items: center; gap: 15px; background: #1b2228; padding: 12px; border-radius: 6px; border: 1px solid #333;">
                                    <div style="flex: 1; display: flex; align-items: center; gap: 10px;">
                                        ...
                                        <img id="logoPreviewImg" src="{{ old('app:logo', config('app.logo', '/assets/svgs/jksoft-logo.svg')) }}" alt="Logo Preview" style="max-height: 42px; max-width: 200px; object-fit: contain;">
                                    </div>
