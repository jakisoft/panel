...
export default {
  account: [
    { path: "/", name: "Account", icon: User, component: AccountOverviewContainer, exact: true },
    { path: "/api", name: "API Credentials", icon: Key, component: AccountApiContainer },
  ...
  server: [
    { path: "/", permission: null, name: "Console", icon: Terminal, component: ServerConsole, exact: true },
    ...
    { path: "/schedules", permission: "schedule.*", name: "Schedules", icon: Calendar, component: ScheduleContainer },
    ...
    { path: "/network", permission: "allocation.*", name: "Network", icon: Globe, component: NetworkContainer },
    { path: "/startup", permission: "startup.*", name: "Startup", icon: PlayCircle, component: StartupContainer },
    { path: "/settings", permission: ["settings.*", "file.sftp"], name: "Settings", icon: Settings, component: SettingsContainer },
    { path: "/activity", permission: "activity.*", name: "Activity", icon: History, component: ServerActivityLogContainer },
  ],
} as Routes;
