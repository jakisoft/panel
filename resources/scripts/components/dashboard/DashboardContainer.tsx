...
export default () => {
    ...
    return (
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
            <div css={tw`mb-4 rounded-xl bg-neutral-800/70 border border-neutral-700 px-4 py-3`}>
                <p css={tw`text-sm text-neutral-200 font-medium`}>Welcome back 👋</p>
                <p css={tw`text-xs text-neutral-400 mt-1`}>
                    Monitor your servers, expiration dates, and usage in one place.
                </p>
            </div>
            <Dialog
