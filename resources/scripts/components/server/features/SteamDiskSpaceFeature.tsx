    ...
    >
      ...
      {isAdmin ? (
        <>
          ...
          <p css={tw`mt-4`}>
            This server has run out of available disk space and cannot complete
            the install or update process.
          </p>
          <p css={tw`mt-4`}>
            Ensure the machine has enough disk space by typing{" "}
            <code css={tw`font-mono bg-elysium-color4 rounded py-1 px-2`}>
              df -h
            </code>{" "}
            on the machine hosting this server. Delete files or increase the
            available disk space to resolve the issue.
          </p>
        ...
        <>
          ...
          <p css={tw`mt-4`}>
            This server has run out of available disk space and cannot complete
            the install or update process. Please get in touch with the
            administrator(s) and inform them of disk space issues.
          </p>
          <div css={tw`mt-8 sm:flex items-center justify-end`}>
            <Button.Danger
              onClick={() => setVisible(false)}
