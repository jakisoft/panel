  ...
  return (
    <PageContentBlock>
      ...
      {hash.replace(/^#/, "").endsWith(".pteroignore") && (
        <div
          css={tw`mb-4 p-4 border-l-4 bg-elysium-color2 rounded-2xl border-cyan-400`}
        >
          <p css={tw`text-neutral-300 text-sm`}>
            You&apos;re editing a{" "}
            <code css={tw`font-mono bg-elysium-color3 rounded-2xl py-px px-1`}>
              .pteroignore
            </code>{" "}
      ...
      <div css={tw`flex justify-end mt-4`}>
        <div css={tw`flex-1 sm:flex-none rounded-2xl bg-transparent mr-4`}>
